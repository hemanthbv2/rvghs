    ...
    return {
      ...
      admissions: {
        ...
        options: [
          ...
          { label: '📞 Contact Admissions', node: 'adm_call' },
          { label: '💰 Fees & Financial Aid', node: 'fees' },
          backOption,
        ],
      },
      adm_docs: {
      ...
      scholarships: {
        message: `🏆 Competitive Exams & Financial Aid:\n\n${s.competitiveExams}`,
        options: [backOption],
      },
      fees: {
        message: `💰 Fee Structure & Concessions\n\nRVGHS offers highly affordable government-subsidized fees for girls' education, with financial aid up to ₹12,000 through competitive exams (NMMS, CHARD GK).\n\nFor exact fee breakdown & admission vouchers:\n📞 Call: ${s.phone}\n📧 Email: ${s.email}`,
        options: [
          { label: '📋 Required Documents', node: 'adm_docs' },
          { label: '📞 Contact School', node: 'contact' },
          backOption,
        ],
      },
      timings: {
...
const KEYWORD_MAP = [
  ...
  { keywords: ['fee', 'fees', 'cost', 'price', 'payment', 'pay', 'amount', 'charge', 'charges', 'expensive', 'free', 'money', 'scholarship', 'scholarships', 'financial aid', 'concession', 'how much', 'fee structure', 'aid', 'voucher', 'bpl'], node: 'fees' },
